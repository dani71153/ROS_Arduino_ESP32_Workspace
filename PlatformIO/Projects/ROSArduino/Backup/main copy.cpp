...
/*Este es el archivo principal del Arduino, tiene el control de los motores 1 y 2.

Tengo el PID del motor 2. Me falta tunear el PID del motor 1. 
...
void processCommand(char* command) {
  ...
  case 'e': {
  // Comando para devolver los valores de los encoders en un formato esperado
